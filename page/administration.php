            ...
            <tbody>
                ...
                foreach ($listeAide as $aide) {
                    ...
                    <tr>
                        ...
                        <td><?php
                foreach ($aide->getVoirAussi() as $seeAlso) {
...
function printModalEditionUtilisateur($u, $index, $listeMoniteurs) {
    ...
    <?php
    if ($u)
        echo "Modification de l'utilisateur '" . $u->getLogin() . "':";
    else
...
function printModalEditionMoniteur($m, $aptitudes) {
    ...
    <form id="modal_edition_moniteur_<?php echo ($m ? $m->getId() : "nouveau"); ?>"
        ...
        <div class="sous-titre">
            <?php
            if ($m)
                echo "Modification du moniteur '" . $m->getPrenom() . " " . $m->getNom() . "':";
            else
                echo "Création d'un nouveau moniteur:";
            ?>
        </div>
...
function printModalEditionEmbarcation($e) {
    ...
    <?php
    if ($e)
        echo "Modification de l'embarcation '" . $e->getLibelle() . "':";
    else
        echo "Création d'une nouvelle embarcation:";
    ?>
        </div>
...
function printModalEditionSite($s) {
    ...
    <?php
    if ($s)
        echo "Modification du site '" . $s->getNom() . "':";
    else
...
function printModalEditionAide($a) {
    ...
    <?php
    if ($a)
        echo "Modification de l'aide '" . $a->getQuestion() . "':";
    else
        echo "Création d'une nouvelle aide:";
    ?>
        </div>
...
/**
 * Affiche les balise HTML option pour les aptitudes de moniteur de la base. Si un tableau est fourni, les aptitudes dans le tableau sont séléctionné

...
function printFiche($numero_fiche) {
	...
	<div>
		<table class="TableStyle infoFiche">
			...
			<tr>
				<td><?php echo $ficheSecurite->getDate();?></td>
				<td><?php echo $ficheSecurite->getTime();?></td>
				<td><?php echo $ficheSecurite->getSite();?></td>
				<td class="responsableColor bold"><?php echo $ficheSecurite->getDirecteurPlonge()->getPrenom()." ".$ficheSecurite->getDirecteurPlonge()->getNom();?></td>
				<td><?php echo $ficheSecurite->getEmbarcation()->getLibelle();?></td>
				<td><?php echo $ficheSecurite->getEmbarcation()->getCommentaire();?></td>
				<td><?php echo $ficheSecurite->getEtat();?></td>
			</tr>
		</table>
	</div>

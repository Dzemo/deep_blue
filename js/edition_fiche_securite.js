...
function fs_enregistrer(){
	...
	//Rassemblement des données à envoyé
	var data_vals = {fiche_securite_id:fiche_securite_id_val, fiche_securite_version: fiche_securite_version_val, date:date_val, heure:heure_val, minute:minute_val, site:site_val, directeur_plonge_id:directeur_plonge_id_val, embarcation_id:embarcation_id_val, liste_palanques: palanques};

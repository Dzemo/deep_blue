...
class Palanque implements JsonSerializable {
    ...
    /**
     * Id de la palanquée sur l'application qui synchronise
     * @var int
     */
    private $idDistant;
    ...
    /**
     * Ajoute le plongeur à la liste des plongeurs de la palanquée
     * @param Plongeur $plongeur
     */
    public function ajouterPlongeur(Plongeur $plongeur) {

<?php
	...
	require_once(dirname(__FILE__).DIRECTORY_SEPARATOR."utils".DIRECTORY_SEPARATOR."mobileUtils.php");

	if(isset($_GET["disabled_mobile_index"])){
	...
	if(showMobileIndex()){
		//Affichage de la page contenant le lien de téléchargement
		?>
			...
			<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<body>
					<div id="mobile-wrapper">
						<div id="content">
							<img class="logo-icon" src="images/logo-100.png">
							<a href="Oxygen.apk">Télécharger l'application Android</a>
							<p>Pour pouvoir installer l'application Android, vous devez autoriser l'installation des applications issues de sources inconnues dans Réglages > Sécurité </p>
							<a href="index.php?disabled_mobile_index=true">Continuer sur la version ordinateur</a>
						</div>
						<div id="mobile-push"></div>
					</div>
					<div id="mobile-footer">
						<span>Oxygen © 3iL Rodez<br/>Flavio DEROO | Raphaël BIDEAU</span>
					</div>
				</body>
			</html>
		<?php
										...
										<?php 
											if($connecte && !$initialisation_mdp){
												...
												?>
													<tr>
														<td>
															<img class="menu-icon" src="images/settings.png">
														</td>
														<td>
															<a class="header-link" href="index.php?page=administration">Administration</a>
														</td>
													</tr>
												<?php
											}
											?>
												<tr>
													<td>
														<img class="menu-icon" src="images/unlog.png"></td>
													<td>
														<a class="header-link" href="traitement/deconnexion_traitement.php">Deconnexion</a>
													</td>
												</tr>
											<?php
											}

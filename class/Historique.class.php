<?php
	...
	class Historique{
		...
		/**
		 * Valeur pour un historique qui à été éféctué lors d'une opération de synchronisation avec 
		 * échange de donné depuis l'application mobile vers le serveur web
		 * @var string
		 */
		const sourceSynchronizePush = "SYNCHRONIZE_PUSH";

		/**
		 * Valeur pour un historique qui à été éféctué lors d'une opération de synchronisation avec 
		 * échange de donné depuis le serveur web vers l'application mobile
		 * @var string
		 */
		const sourceSynchronizePull = "SYNCHRONIZE_PULL";

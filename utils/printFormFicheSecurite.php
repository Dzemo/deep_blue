                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input 	type="text"
                                                    ...
                                                    value="<?php if ($m) echo $f->getDate();
                                                        else echo tmspToDate(time()); ?>"/>
    ...
    ?>
        ...
        function getOptionAutocompletePlongeur(numero_palanque, numero_plongeur, champs) {
            ...
            for (var i = 0; i < rawSource.length; i++) {
                ...
                if (champs == "nom")
                    source_val[i].value = rawSource[i].nom;
                if (champs == "prenom")
                    source_val[i].value = rawSource[i].prenom;
                if (champs == "date_naissance")
                    source_val[i].value = rawSource[i].date_naissance;
            }
            return {
                source: source_val,
                minLength: 0,
        ...
        <div class="types">
            ...
            <table class="inside-panel">
                ...
                <tr>
                    ...
                    else echo $GLOBALS['plongeDefaultProf']; ?>"/>
                    </td>
                    <td class="duree">
                    ...
                    else echo $GLOBALS['plongeDefaultDuree']; ?>"/>
                    </td>
                    <td>								
                        <input 	type="text" 
